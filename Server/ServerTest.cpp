/////////////////////////////////////////////////////////////////////////////
// ServerTest.cpp - Executive to Demosntrate the Peer to Peer Communication//
// Ver 1.1                                                                 //
...
{	
	std::thread receiverThread(&Receiver::ConnectServer, std::ref(objRec), std::stoi(SrcPort));
...
int main(int argc, char *argv[])
{
	...
	try
	{
		...
		title("Testing Socket SERVER: " + SrcPort, '=');
		Verbose v(true);
		Receiver objRec;		
