...
namespace CppCliWindows
{
	ref class WPFCppCliDemo : Window
	{
		...
		TabItem^ hFileManagementTab = gcnew TabItem();
		...
		Button^ hTxtButton = gcnew Button();
		Button^ hFileButton = gcnew Button();
		Button^ hUploadButton = gcnew Button();
		Button^ hDownloadButton = gcnew Button();
		TextBlock^ hTextBlock1 = gcnew TextBlock();
		TextBlock^ hBrowseTxt = gcnew TextBlock();
		TextBlock^ hServerTxt = gcnew TextBlock();
		TextBlock^ hSPortTxt = gcnew TextBlock();
		TextBox^ hConnPortTxt = gcnew TextBox();
		TextBox^ hSearchTxt = gcnew TextBox();
		TextBox^ hListenPortTxt = gcnew TextBox();
	...
	private:
		...
		void ConnectServer(Object^ sender, RoutedEventArgs^ args);
		void DisplayFiles(String^ msg);
		...
		void SearchFiles(Object^ obj, RoutedEventArgs^ args);

		std::string toStdString(String^ pStr);
		String^ toSystemString(std::string& str);
		void setTextBlockProperties();
		void setTextBlockProperties0();
		void setTextBlockProperties1();
		void setTextBlockProperties2();
		void setTextBlockProperties3();
